                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="flex items-center gap-1 text-xs text-muted-foreground dark:text-foreground/60 ml-auto">
                    ...
                    <AnimatePresence>
                      {isHovered && (
                        ...
                        >
                          <div className="flex items-center gap-1.5 mt-2.5 pt-2.5 border-t border-border/40 text-xs text-brand-600 dark:text-brand-300 font-semibold">
